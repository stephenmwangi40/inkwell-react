    ...
    <div className="flex min-h-screen flex-col bg-slate-tint">
      <div className="container-app flex flex-1 flex-col items-center justify-center py-12">
        ...
        <div className="w-full auth-card max-w-md rounded-2xl border border-line bg-white p-6 shadow-md sm:p-8">
          ...
          <p className="mt-1 text-sm text-slate">Log in to track orders and message your writer.</p>
          <form onSubmit={onSubmit} className="mt-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-[10px] border border-line px-3.5 py-2.5 text-[0.95rem] outline-none focus:border-blue focus:ring-2 focus:ring-blue/20"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-[10px] border border-line px-3.5 py-2.5 pr-16 text-[0.95rem] outline-none focus:border-blue focus:ring-2 focus:ring-blue/20"
                  placeholder="••••••••"
                />
                <button type="button" onClick={() => setShow(!show)} className="absolute right-3 top-1/2 -translate-y-1/2 text-sm font-medium text-slate hover:text-blue">
                  {show ? "Hide" : "Show"}
                </button>
              </div>
            </div>
          ...
          <p className="mt-5 text-center text-sm text-slate">
            No account? <Link to="/signup" className="font-medium text-blue hover:underline">Sign up</Link>
          </p>
          <p className="mt-3 text-center text-xs text-slate">
            Demo: amara@brightleaf.co / demo1234
          </p>
        </div>
      </div>
    </div>
